...
public:
   ...
   //Jixie: return the helix center Xc
   virtual       Double_t   GetXc       () const;
   //Jixie: return the helix center Yc
   virtual       Double_t   GetYc       () const;
...
#if __GNUC__ < 4 && !defined(__STRICT_ANSI__) && !defined(WIN32)
